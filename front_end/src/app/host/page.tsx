      ...
      <section className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        <div className="rounded-2xl border border-gray-100 bg-white p-6 lg:col-span-2">
          <div className="mb-4 flex items-center justify-between border-b border-gray-100 pb-3">
            ...
            <Link href="/host/listings" className="flex items-center gap-1 text-[10px] font-semibold text-app-accent hover:underline">
          ...
          <div className="space-y-3">
            {listings.length === 0 ? (
              <div className="rounded-xl border border-dashed border-gray-200 py-8 text-center">
                ...
                <Link href="/host/listings/new" className="mt-2 inline-block text-xs font-semibold text-app-primary hover:underline">
        ...
        <div className="rounded-2xl border border-gray-100 bg-white p-6">
          ...
          <div className="space-y-3">
            <Shortcut href="/host/calendar" icon={<Calendar className="h-4 w-4" />} title="Lịch nhận khách" description="Xem ngày mở bán, ngày khóa và lượng đặt." />
            <Shortcut href="/host/availability" icon={<PackageCheck className="h-4 w-4" />} title="Khả dụng & sức chứa" description="Cấu hình số phòng/chỗ và khung giờ." />
            <Shortcut href="/host/listings/new" icon={<PlusCircle className="h-4 w-4" />} title="Đăng thêm dịch vụ" description="Tạo lưu trú, trải nghiệm hoặc dịch vụ mới." />
            <Shortcut href="/host/earnings" icon={<DollarSign className="h-4 w-4" />} title="Thu nhập & chi trả" description="Xem payout, hoa hồng và số thực nhận." />
          </div>
        </div>
      </section>
    </div>
