...
export default function EnterpriseEarnings() {
  ...
  return (
    <div className="space-y-6 animate-smooth-appear">
      ...
      <section className="grid grid-cols-1 gap-4 md:grid-cols-4">
        ...
        <Metric title="Doanh nghiệp thực nhận" value={formatCurrency(totals.hostAmount)} icon={<ShieldCheck className="h-4 w-4" />} />
